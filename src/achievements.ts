...
const achievementContainer: HTMLElement | null = document.querySelector(
...
export function SetUnlockedAchievements() {
  ...
  achievements.forEach((value, index) => {
    var obtainedAchievement = gameObjects.game.achievements.find(
      (x) => x.name == value.id
    );
    if (
