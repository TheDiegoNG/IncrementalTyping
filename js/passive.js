...
function SetGenerators() {
  basicGenerator.textContent = `Generate Passive Points! | Generators: ${game.passiveGenerators[1][0].toFixed(2)} (Bought: ${game.passiveGenerators[0][0]}) | Cost: ${game.passiveGenerators[2][0].toFixed(2)} Passive Points`
  PPGenerator.textContent = `Generate the First Generator | Generators: ${game.passiveGenerators[1][1].toFixed(2)} (Bought: ${game.passiveGenerators[0][1]}) | Cost: ${game.passiveGenerators[2][1].toFixed(2)} 1st Generators`
  PPGenerator2.textContent = `Generate the Second Generator | Generators: ${game.passiveGenerators[1][2].toFixed(2)} (Bought: ${game.passiveGenerators[0][2]}) | Cost: ${game.passiveGenerators[2][2].toFixed(2)} 2nd Generators`
  PPGenerator3.textContent = `Generate the Third Generator | Generators: ${game.passiveGenerators[1][3].toFixed(2)} (Bought: ${game.passiveGenerators[0][3]}) | Cost: ${game.passiveGenerators[2][3].toFixed(2)} 3rd Generators`
  PPGenerator4.textContent = `Generate the Fourth Generator | Generators: ${game.passiveGenerators[1][4].toFixed(2)} (Bought: ${game.passiveGenerators[0][4]}) | Cost: ${game.passiveGenerators[2][4].toFixed(2)} 4th Generators`
  PPGenerator5.textContent = `Generate the Fifth Generator | Generators: ${game.passiveGenerators[1][5].toFixed(2)} (Bought: ${game.passiveGenerators[0][5]}) | Cost: ${game.passiveGenerators[2][5].toFixed(2)} 5th Generators`
  PPGenerator6.textContent = `Generate the Sixth Generator | Generators: ${game.passiveGenerators[1][6].toFixed(2)} (Bought: ${game.passiveGenerators[0][6]}) | Cost: ${game.passiveGenerators[2][6].toFixed(2)} 6th Generators`
...
function CalculatePassiveGenerators() {
  for (let index = 1; index < game.passiveGenerators[0].length; index++) {
    if(IsPurchasedPassiveUpgrade(5))
    {
      game.passiveGenerators[1][index - 1] += game.passiveGenerators[1][index] * game.passiveGenerators[0].reduce((acc, val) => acc + val, 0);
    }
    else
    {
